...
If the service invoked by the service activator throws a `FooException`, the framework wraps it in a `MessagingException`, attaching the message paseed to the service activator in the `failedMessage` property.
